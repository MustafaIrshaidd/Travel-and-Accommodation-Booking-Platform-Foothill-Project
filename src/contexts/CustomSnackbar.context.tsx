...
import { CustomSnackbarProps } from "@components/adhocs/CustomSnackbar/types";
...
export const CustomSnackbarContext = createContext<
  CustomSnackbarContextProps | undefined
>(undefined);

export const CustomSnackbarProvider: React.FC<{ children: ReactNode }> = ({
  children,
}) => {
